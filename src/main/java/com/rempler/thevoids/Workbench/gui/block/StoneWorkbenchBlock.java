package com.rempler.thevoids.Workbench.gui.block;
...
public class StoneWorkbenchBlock extends Block implements IWaterLoggable {
    ...
    public StoneWorkbenchBlock(Block.Properties p_i48440_1_) {
        super(p_i48440_1_);
    ...
    public INamedContainerProvider getContainer(BlockState state, World world, BlockPos pos) {
        ...
        return te instanceof StoneWorkbenchTileEntity ? (INamedContainerProvider) te : null;
    }
    ...
    public void onReplaced(BlockState state, @Nonnull World worldIn, @Nonnull BlockPos pos, @Nonnull BlockState newState, boolean isMoving) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (tileentity instanceof StoneWorkbenchTileEntity) {
                dropItems(((StoneWorkbenchTileEntity) tileentity).input, worldIn, pos);
