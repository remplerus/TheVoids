package com.rempler.thevoids.Workbench.gui.inventory;
...
public class StoneWorkbenchCraftingInventory extends CraftingInventory {

    private boolean doNotCallUpdates;
    protected final StoneWorkbenchItemHandler inv;

    public StoneWorkbenchCraftingInventory(Container eventHandler, StoneWorkbenchItemHandler itemHandler) {
